...
//     const closeProjectDisplay = document.createElement("button");
//     projectDisplay.appendChild(closeProjectDisplay);
//     closeProjectDisplay.innerHTML = "&#10006";
//     closeProjectDisplay.classList.add("close-project-display");

//     closeProjectDisplay.addEventListener("click", () => {
//       projectDisplay.classList.add("project-display-clicked");
